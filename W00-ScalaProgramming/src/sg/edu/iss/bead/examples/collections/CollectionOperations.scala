package sg.edu.iss.bead.examples.collections

object CollectionOperations extends App {

  val source = io.Source.fromFile("/home/cloudera/workspace/W00-ScalaProgramming/src/sg/edu/iss/bead/examples/collections/football_stats.csv")
